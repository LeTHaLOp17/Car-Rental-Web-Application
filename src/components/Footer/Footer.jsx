      ...
      <Container>
        <Row>
          <Col lg="4" md="4" sm="12">
            ...
            With competitive rates and seamless booking options, we're your trusted partner for hassle-free travels. Experience the freedom of the open road with us.
            </p>
          </Col>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Model Town, Phagwara, Punjab</p>
              <p className="office__info">Phone: +91-8797512418</p>

              <p className="office__info">Email: aksingh6224@gmail.com</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                Ayush Kumar Patel. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
